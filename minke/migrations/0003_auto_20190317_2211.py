    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_data', picklefield.fields.PickledObjectField(blank=True, editable=False, null=True)),
        ...
        migrations.AddField(
            ...
            name='session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='minke.SessionData'),
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
            ...
            bases=(minke.messages.ProxyMixin, 'minke.messagedata'),
        ),
        migrations.AddField(
            model_name='host',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='minke.HostGroup'),
        ),
        migrations.CreateModel(
